...
const LandingPage = () => {
    // const image = '../assets/content-image01.jpg'
    return (
                ...
                {["We Create", "Eye Opening", "Presentation"].map((item, index) => (
                    <div key={index} className="masker">
                        <div className="w-fit flex items-center overflow-hidden ">
                            {index === 1 && (<motion.div initial={{width:0}} animate={{width:"10vw"}} transition={{ease:[0.76,0,0.24,1], duration:1}} style={{background:`url(${image})`,backgroundSize:"cover", backgroundRepeat:"no-repeat"}} className=" h-[5vw] rounded relative top-1  "></motion.div>)}
